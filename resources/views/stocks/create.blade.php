<x-app-layout>
    ...
    <div class="py-12 bg-gray-50 dark:bg-gray-950 min-h-screen transition-colors duration-500">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div
                class="bg-white dark:bg-gray-900 overflow-hidden shadow-xl sm:rounded-lg border border-gray-100 dark:border-gray-800">
                <div class="p-6 bg-white dark:bg-gray-900 border-b border-gray-200 dark:border-gray-800">
                    <form method="POST" action="{{ route('stocks.store') }}">
                        ...
                        <div id="business_fields"
                            class="mt-6 p-4 bg-gray-50 dark:bg-gray-800/50 rounded-lg border border-gray-200 dark:border-gray-700 transition-colors">
                            <h3
                                class="text-sm font-bold text-gray-700 dark:text-gray-200 mb-3 flex items-center uppercase tracking-wider">
                                <svg class="w-4 h-4 mr-1 text-indigo-500" fill="none" stroke="currentColor"
                                    viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                        d="M13 16h-1v-4h-1m1-4h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z"></path>
                                </svg>
                                {{ __('Business Specific Details') }}
                                ({{ $businessType ? __($businessType) : __('Default') }})
                            </h3>
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                                @if(in_array('brand', $requiredFields))
                                    <div>
                                        ...
                                        <x-input id="brand" class="block mt-1 w-full" type="text"
                                            name="business_attributes[brand]" :value="old('business_attributes.brand')" />
                                    </div>
                                @endif
                                ...
                                @if(in_array('model_number', $requiredFields))
                                    <div>
                                        ...
                                        <x-input id="model_number" class="block mt-1 w-full" type="text"
                                            name="business_attributes[model_number]"
                                            :value="old('business_attributes.model_number')" />
                                    </div>
                                @endif
                                ...
                                @if(in_array('serial_number', $requiredFields))
                                    <div>
                                        ...
                                        <x-input id="serial_number" class="block mt-1 w-full" type="text"
                                            name="business_attributes[serial_number]"
                                            :value="old('business_attributes.serial_number')" />
                                    </div>
                                @endif
                                ...
                                @if(in_array('imei_number', $requiredFields))
                                    <div>
                                        ...
                                        <x-input id="imei_number" class="block mt-1 w-full" type="text"
                                            name="business_attributes[imei_number]"
                                            :value="old('business_attributes.imei_number')" />
                                    </div>
                                @endif
                                ...
                                @if(in_array('warranty', $requiredFields))
                                    <div>
                                        ...
                                        <x-input id="warranty" class="block mt-1 w-full" type="number"
                                            name="business_attributes[warranty]"
                                            :value="old('business_attributes.warranty')" />
                                    </div>
                                @endif
                                ...
                                @if(in_array('part_number', $requiredFields))
                                    <div>
                                        ...
                                        <x-input id="part_number" class="block mt-1 w-full" type="text"
                                            name="business_attributes[part_number]"
                                            :value="old('business_attributes.part_number')" />
                                    </div>
                                @endif
                                ...
                                @if(in_array('specification', $requiredFields))
                                    <div>
                                        ...
                                        <x-input id="specification" class="block mt-1 w-full" type="text"
                                            name="business_attributes[specification]"
                                            :value="old('business_attributes.specification')" />
                                    </div>
                                @endif
                                ...
                                @if(in_array('certification', $requiredFields))
                                    <div>
                                        ...
                                        <x-input id="certification" class="block mt-1 w-full" type="text"
                                            name="business_attributes[certification]"
                                            :value="old('business_attributes.certification')" />
                                    </div>
                                @endif
                                ...
                                @if(in_array('batch_number', $requiredFields))
                                    <div>
                                        ...
                                        <x-input id="batch_number" class="block mt-1 w-full" type="text"
                                            name="business_attributes[batch_number]"
                                            :value="old('business_attributes.batch_number')" />
                                    </div>
                                @endif
                                ...
                                @if(in_array('expiry_date', $requiredFields))
                                    <div>
                                        ...
                                        <x-input id="expiry_date" class="block mt-1 w-full" type="date"
                                            name="business_attributes[expiry_date]"
                                            :value="old('business_attributes.expiry_date')" />
                                    </div>
                                @endif
                                ...
                                @if(in_array('composition', $requiredFields))
                                    <div>
                                        ...
                                        <x-input id="composition" class="block mt-1 w-full" type="text"
                                            name="business_attributes[composition]"
                                            :value="old('business_attributes.composition')" />
                                    </div>
                                @endif
                                ...
                                @if(in_array('volume', $requiredFields))
                                    <div>
                                        ...
                                        <x-input id="volume" class="block mt-1 w-full" type="text"
                                            name="business_attributes[volume]" :value="old('business_attributes.volume')" />
                                    </div>
                                @endif
                                ...
                                @if(in_array('variety', $requiredFields))
                                    <div>
                                        ...
                                        <x-input id="variety" class="block mt-1 w-full" type="text"
                                            name="business_attributes[variety]"
                                            :value="old('business_attributes.variety')" />
                                    </div>
                                @endif
                                ...
                                @if(in_array('size', $requiredFields))
                                    <div>
                                        ...
                                        <x-input id="size" class="block mt-1 w-full" type="text"
                                            name="business_attributes[size]" :value="old('business_attributes.size')"
                                            :placeholder="__('e.g. XL, 42, 32')" />
                                    </div>
                                @endif
                                ...
                                @if(in_array('color', $requiredFields))
                                    <div>
                                        ...
                                        <x-input id="color" class="block mt-1 w-full" type="text"
                                            name="business_attributes[color]" :value="old('business_attributes.color')" />
                                    </div>
                                @endif
                                ...
                                @if(in_array('material', $requiredFields))
                                    <div>
                                        ...
                                        <x-input id="material" class="block mt-1 w-full" type="text"
                                            name="business_attributes[material]"
                                            :value="old('business_attributes.material')" />
                                    </div>
                                @endif
                                ...
                                @if(in_array('dimension', $requiredFields))
                                    <div>
                                        ...
                                        <x-input id="dimension" class="block mt-1 w-full" type="text"
                                            name="business_attributes[dimension]"
                                            :value="old('business_attributes.dimension')" :placeholder="__('e.g. 10x20x30')" />
                                    </div>
                                @endif
                                ...
                                @if(in_array('thickness', $requiredFields))
                                    <div>
                                        ...
                                        <x-input id="thickness" class="block mt-1 w-full" type="text"
                                            name="business_attributes[thickness]"
                                            :value="old('business_attributes.thickness')" />
                                    </div>
                                @endif
                                ...
                                @if(in_array('grade', $requiredFields))
                                    <div>
                                        ...
                                        <x-input id="grade" class="block mt-1 w-full" type="text"
                                            name="business_attributes[grade]" :value="old('business_attributes.grade')" />
                                    </div>
                                @endif
                                ...
                                @if(in_array('weight', $requiredFields))
                                    <div>
                                        ...
                                        <x-input id="weight" class="block mt-1 w-full" type="number" step="0.001"
                                            name="business_attributes[weight]" :value="old('business_attributes.weight')" />
                                    </div>
                                @endif
                                ...
                                @if(in_array('purity', $requiredFields))
                                    <div>
                                        ...
                                        <x-input id="purity" class="block mt-1 w-full" type="text"
                                            name="business_attributes[purity]" :value="old('business_attributes.purity')" />
                                    </div>
                                @endif
                                ...
                                @if(in_array('hallmark', $requiredFields))
                                    <div>
                                        ...
                                        <x-input id="hallmark" class="block mt-1 w-full" type="text"
                                            name="business_attributes[hallmark]"
                                            :value="old('business_attributes.hallmark')" />
                                    </div>
                                @endif
                                ...
                                @if(in_array('making_charges', $requiredFields))
                                    <div>
                                        ...
                                        <x-input id="making_charges" class="block mt-1 w-full" type="number" step="0.01"
                                            name="business_attributes[making_charges]"
                                            :value="old('business_attributes.making_charges')" />
                                    </div>
                                @endif
                            </div>
                            ...
                            @if(empty($requiredFields))
                                <p class="text-sm text-gray-500 italic">
                                    {{ __('No additional specialized fields for your business type.') }}
                                </p>
                            @endif
                        </div>

                        <!-- Unit Tracking Section -->
                        <div id="unit_tracking_section"
                            class="mt-6 p-4 bg-white dark:bg-gray-900 rounded-lg border-2 border-dashed border-gray-100 dark:border-gray-800 transition-colors">
                            <div class="flex items-center justify-between mb-4">
                                <h3
                                    class="text-md font-bold text-gray-800 dark:text-white flex items-center uppercase tracking-tight">
                                ...
                                <div class="flex items-center gap-2">
                                    <button type="button" onclick="autoGenerateAllBarcodes()"
                                        class="px-3 py-1.5 bg-blue-600 hover:bg-blue-700 text-white text-[10px] font-bold rounded-lg transition-all active:scale-95">
                                        {{ __('Auto-Generate All') }}
                                    </button>
                                    <div
                                        class="flex items-center bg-indigo-50 dark:bg-indigo-900/30 px-3 py-1 rounded-full">
                                        <input type="checkbox" id="enable_tracking" name="enable_tracking" value="1"
                                            class="rounded border-gray-300 dark:border-gray-700 text-indigo-600 shadow-sm focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50 dark:bg-gray-800"
                                            checked>
                                        <label for="enable_tracking"
                                            class="ml-2 text-xs font-bold text-indigo-700 dark:text-indigo-400">{{ __('Track Unit Details') }}</label>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div id="tracking_container" class="space-y-2">
                                <p
                                    class="text-sm text-gray-400 dark:text-gray-500 italic text-center py-6 bg-gray-50 dark:bg-gray-800/40 rounded-2xl border border-gray-100 dark:border-gray-700 shadow-inner">
                            ...
                            <div id="unit_scanner_container" class="mt-4 hidden">
                                <div class="p-4 bg-gray-900 rounded-lg shadow-xl">
                                    <div class="flex items-center justify-between mb-3">
                                        <span
                                            class="text-xs font-bold text-indigo-400 uppercase tracking-widest">{{ __('Live Scanner') }}</span>
                                        <button type="button" id="stop_unit_scanner"
                            ...
                            <div class="mt-4 flex justify-center">
                                <button type="button" id="start_unit_scanner"
                                    class="inline-flex items-center px-4 py-2 border border-indigo-600 dark:border-indigo-500 text-sm font-bold rounded-xl text-indigo-600 dark:text-indigo-400 bg-white dark:bg-gray-900 hover:bg-indigo-50 dark:hover:bg-indigo-900/30 transition-all shadow-sm active:scale-95">
                                    <svg class="w-5 h-5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                            d="M12 4v1m6 11h2m-6 0h-2v4m0-11v3m0 0h.01M12 12h4.01M16 20h4M16 12v4m1 4V4a2 2 0 00-2-2H6a2 2 0 00-2 2v16a2 2 0 002 2h10a2 2 0 002-2zM9 16H9m0 0H9m0 0H9">
                                        </path>
                                    </svg>
                                    {{ __('Bulk Scan Boxes') }}
                                </button>
                        ...
                        <div
                            class="flex items-center justify-end mt-8 pt-4 border-t border-gray-100 dark:border-gray-800">
                            <a href="{{ route('dashboard') }}"
                                class="text-gray-600 dark:text-gray-400 font-bold hover:text-gray-900 dark:hover:text-white mr-6 transition-colors transition-all">{{ __('Cancel') }}</a>
    ...
    <script>
        ...
        function generateUnitRows() {
            ...
            if (qty > 10000) {
                alert('{{ __("Quantity is too large for individual tracking. Please enter a value under 10000.") }}');
            ...
            trackingContainer.innerHTML = `
                <div class="flex flex-col items-center justify-center py-10 bg-gray-50 dark:bg-gray-800/40 rounded-2xl border border-gray-100 dark:border-gray-700">
                    ...
                    <p class="text-sm font-bold text-gray-500 dark:text-gray-400">{{ __('Generating unit forms... Please wait.') }}</p>
                </div>
            `;
            ...
            function processChunk() {
                ...
                const end = Math.min(current + CHUNK_SIZE - 1, qty);
                let chunkHtml = '';
                for (let i = current; i <= end; i++) {
                    chunkHtml += generateRowHTML(i);
                }

                if (current === 1) {
                    trackingContainer.innerHTML = chunkHtml;
                } else {
                    trackingContainer.insertAdjacentHTML('beforeend', chunkHtml);
                }

                current = end + 1;

                if (current <= qty) {
                    renderTimeout = setTimeout(processChunk, 15); // Yield back to main thread
                } else {
                    isRendering = false;
                }
            }

            // Start rendering chunk
            setTimeout(processChunk, 50);
        }

        const debouncedGenerateUnitRows = debounce(() => {
            isRendering = false; // Stop current renders
            generateUnitRows();
        }, 500);
        ...
        function autoGenerateAllBarcodes() {
            ...
            if (isRendering) {
                alert('{{ __("Please wait for all unit forms to finish generating before generating barcodes.") }}');
                return;
            }

            const btn = document.querySelector('button[onclick="autoGenerateAllBarcodes()"]');
            const originalText = btn.innerHTML;
            btn.innerHTML = `<svg class="animate-spin h-3 w-3 mr-1 inline" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"><circle class="opacity-25" cx="12" cy="12" r="10" stroke="currentColor" stroke-width="4"></circle><path class="opacity-75" fill="currentColor" d="M4 12a8 8 0 018-8V0C5.373 0 0 5.373 0 12h4zm2 5.291A7.962 7.962 0 014 12H0c0 3.042 1.135 5.824 3 7.938l3-2.647z"></path></svg> {{ __('Generating...') }}`;
            btn.disabled = true;
            ...
            function processBarcodeChunk() {
                const end = Math.min(current + CHUNK_SIZE - 1, qty);
                for (let i = current; i <= end; i++) {
                    const input = document.getElementById(`unit_barcode_${i}`);
                    if (input && !input.value) {
                        const randomStr = Math.random().toString(36).substring(2, 6).toUpperCase();
                        input.value = `STK-${dateStr}-${randomStr}`;
                    }
                }

                current = end + 1;
                if (current <= qty) {
                    setTimeout(processBarcodeChunk, 15);
                } else {
        ...
        // Events
        quantityInput.addEventListener('input', debouncedGenerateUnitRows);
        enableTrackingItem.addEventListener('change', debouncedGenerateUnitRows);
